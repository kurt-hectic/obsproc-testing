...
python3 /app/notification-generator.py  | mosquitto_pub -u everyone -P everyone --host $BROKER_HOST --port $BROKER_PORT -t cache/a/wis2/ru-aviamettelecom/data/core/weather/surface-based-observations/synop --stdin-line
